...
- Build the following features on your website:
    ...
    XXX- A user should be able to see a list of all scientists

   XXX - Clicking on a scientist should take you to a detail page about the scientist. This detail page should list all the planets they have visited and the name of the mission that took them there.

    XXX- A user should be able to create a new scientist.
    ...
    XXX- A user should be able to edit the details of a scientist

    XXX- A user should be able to delete a scientist
